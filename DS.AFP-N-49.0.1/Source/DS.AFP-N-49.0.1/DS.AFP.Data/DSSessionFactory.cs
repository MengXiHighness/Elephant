...
namespace Spring.Data.NHibernate
{
    ...
    public class DSSessionFactoryObject : IFactoryObject, IInitializingObject, IPersistenceExceptionTranslator, IDisposable
        , IApplicationContextAware
    {
        ...
        protected static readonly ILog log =
            LogManager.GetLogger(typeof(DSSessionFactoryObject));

        #endregion

        #region Constructor (s)
        /// <summary>
        /// Initializes a new instance of the <see cref="DSSessionFactoryObject"/> class.
        /// </summary>
        public DSSessionFactoryObject()
        {
