...
namespace DS.AFP.Communication.Chain
{
        ...
        where TRequestInfo : IRequestInfo
    {
        ...
        //查询标记
        private readonly SearchMarkState<byte> m_SearchState = new SearchMarkState<byte>(Encoding.UTF8.GetBytes(SocketParams.Terminator));
        ...
        protected FixedSizeReceiveFilter()
        {
