...
using DS.AFP.Communication.Http.Client.Interceptor;
using DS.AFP.Communication.Http.Converters;
using DS.AFP.Communication.Http.Converters.Xml;
...
#endif
using DS.AFP.Communication.Rest.Client.Support;
using UriTemplate = DS.AFP.Communication.Util.UriTemplate; // UriTemplate exists in .NET Framework since 3.5
using ArgumentUtils = DS.AFP.Communication.Util.ArgumentUtils;
using Common.Logging;

namespace DS.AFP.Communication.Rest.Client
{
    /// <summary>
    ...
    public class RestTemplate : IRestOperations
    {
        ...
        private static readonly ILog LOG = LogManager.GetLogger(typeof(RestTemplate));
#endif
        #endregion
