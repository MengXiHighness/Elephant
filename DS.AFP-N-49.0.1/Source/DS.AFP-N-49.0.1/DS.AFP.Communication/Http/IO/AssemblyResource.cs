...
using DS.AFP.Communication.Util;

namespace DS.AFP.Communication.IO
{
    /// <summary>
    /// An <see cref="DS.AFP.Communication.IO.IResource"/> implementation for resources stored within assemblies 
    ...
    /// <seealso cref="DS.AFP.Communication.IO.IResource"/>
    public class AssemblyResource : AbstractResource
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="DS.AFP.Communication.IO.AssemblyResource"/> class 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DS.AFP.Communication.IO.AssemblyResource"/> class. 
        /// </summary>
        /// <param name="fileName">The name of the file in the assembly.</param>
        ...
        /// </returns>
        /// <seealso cref="DS.AFP.Communication.IO.IResource.IsOpen"/>
