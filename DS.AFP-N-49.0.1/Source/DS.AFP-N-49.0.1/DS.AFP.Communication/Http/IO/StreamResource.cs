...
namespace DS.AFP.Communication.IO
{
	...
	/// <remarks>
	/// <para>
	/// In contrast to other <see cref="DS.AFP.Communication.IO.IResource"/> implementations, 
    /// this is an adapter for an already opened resource - the <see cref="DS.AFP.Communication.IO.IResource.IsOpen"/> 
